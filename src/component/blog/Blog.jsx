           ...
           <div className='grid grid-cols-1 md:grid-cols-3 gap-4 space-y-3'>
           
            {
                blogpost.map(blog=>(
                        ...
                        <Link className=' no-underline ' to={`/singleblog/${blog.id}`} key={blog.id} id="blog-link">
                         ...
                         <div className=' p-3 space-y-5 gap-3'>
                           <p className='text-lg font-semibold text-start blog-title no-underline text-[#6E6E6E] hover:text-[#6E6E6E] '> {blog.title} </p>
                               ...
                               <p className='text-base text-[#6E6E6E]  blog-date no-underline'> {blog.date} </p>
                                <p className='flex items-center  blog-date '> 
                                   <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-eye me-2 font-bold " viewBox="0 0 16 16">
