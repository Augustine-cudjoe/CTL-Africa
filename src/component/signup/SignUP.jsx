...
function Signup() {
  ...
  return (
    <div className=' signup min-h-dvh'>
       <OtherNav/>
     <main className='login min-h-screen'>
        <section className=' min-h-screen md:py-32 py-20'>
            ...
            <h1 className="text-[#000000] md:text-[40px] text-xl font-normal text-center mb-20">Create your account</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10 items-center" >
             <p className='md:w-[260px]  w-full text-[#2E2E2E]  border border-[#E9E9E9] p-3 flex justify-center items-center gap-3 mt-0'>
             ...
             <p className='md:w-[260px]  w-full text-[#2E2E2E]  border border-[#E9E9E9] p-3 flex justify-center items-center gap-3'> 
            ...
            <div className="flex flex-col space-y-5  mb-10">
                <input className=' border border-[#E9E9E9] w-full p-2 rounded-md' type='text' placeholder='Last Name'/>
                <input className=' border border-[#E9E9E9] w-full p-2 rounded-md' type='text' placeholder='First Name'/>
           ...
           <button type='button' className='bg-[#3C0644] text-white w-[292px] p-3 rounded-md my-5' id='login-btn'>SignUp</button>
            </div>
            <p className='text-sm font-normal text-center '> Forget your password ?</p>
              <div className="flex items-center justify-center mt-16">
              <p className='flex items-center gap-3 text-center  text-sm '> Already have an account? 
